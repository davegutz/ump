...
unsigned char* format_desc[] = {
  (unsigned char*)"",
  (unsigned char*)"8 bit PseudoColor (dithering)",
  (unsigned char*)"8 bit StaticGray",
  (unsigned char*)"15 bit TrueColor (LE)",
  (unsigned char*)"16 bit TrueColor (LE)",
  (unsigned char*)"15 bit TrueColor (BE)",
  (unsigned char*)"16 bit TrueColor (BE)",
  (unsigned char*)"24 bit TrueColor (LE: bgr)",
  (unsigned char*)"32 bit TrueColor (LE: bgr-)",
  (unsigned char*)"24 bit TrueColor (BE: rgb)",
  (unsigned char*)"32 bit TrueColor (BE: -rgb)",
  (unsigned char*)"16 bit TrueColor (lut)",
  (unsigned char*)"32 bit TrueColor (lut)",
  (unsigned char*)"16 bit YUV 4:2:2",
  (unsigned char*)"16 bit YUV 4:2:2 (planar)",
  (unsigned char*)"12 bit YUV 4:2:0 (planar)",
  (unsigned char*)""
};
...
void *getGrabber(int *grabberFormat_, int *grabberWidth_, int *grabberDepth_,
	       color_conv *grabberConv_, int *grabberLinelength_,
	       int *grabberHeight_)
{
  *grabberFormat_ = grabber_format;
  *grabberWidth_  = grabber_width;
  *grabberDepth_  = grabber_depth;
  *grabberConv_    = grabber_conv;
  *grabberLinelength_ = grabber_linelength;
  *grabberHeight_ = grabber_height;
  fprintf(stderr,"grabber_data=%p\n", grabber_data);
  return grabber_data;
}
